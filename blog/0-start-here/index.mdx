...
hidden: ""
---
__I am fascinated by distributed systems. I'm going to learn about them by building a clone of the Uber app.__
...
### Frontend
There will be a frontend app that will display the city map (see above). You'll see active routes and cars moving along them in real-time. In addition, I will also build a monitoring dashboard that will show how the system is performing, such as database loads, queue sizes, or requests per second.
