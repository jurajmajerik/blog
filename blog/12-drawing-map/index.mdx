...
This is the final result. Sure, it's not a high fidelity map, but it will do for now. Eventually, I want to plot the app on an actual city map, such as one from OpenStreetMap.
